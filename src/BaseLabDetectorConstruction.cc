...
void BaseLabDetectorConstruction::SetSampleSkinThickness(G4double thickness)
{
  if (thickness >= 0.) {
...
void BaseLabDetectorConstruction::SetSampleEndCapArea(G4double area)
{
  if (area > 0.) {
...
void BaseLabDetectorConstruction::SetSampleEndCapThickness(G4double thickness)
{
  if (thickness >= 0.) {
...
void BaseLabDetectorConstruction::SetSampleAxis(const G4String& axisName)
{
...
G4double BaseLabDetectorConstruction::GetSampleSkinThickness() const
{
  return fConfig.sampleSkinThickness;
}

G4double BaseLabDetectorConstruction::GetSampleEndCapArea() const
{
  return fConfig.sampleEndCapTargetArea;
}

G4double BaseLabDetectorConstruction::GetSampleEndCapThickness() const
{
  return fConfig.sampleEndCapThickness;
}

G4double BaseLabDetectorConstruction::ComputeSampleEndCapRadius() const
{
...
G4String BaseLabDetectorConstruction::GetSampleAxis() const
{
...
G4RotationMatrix* BaseLabDetectorConstruction::BuildSampleRotation() const
{
