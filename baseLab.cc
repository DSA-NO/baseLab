...
#include "BaseLabMacroRuntime.hh"
...
using BaseLab::MacroRuntime::ApplyWorkingDirectory;
using BaseLab::MacroRuntime::ResolveRuntimeMacroConfig;
...
{
  G4cout << " Usage: " << G4endl;
  G4cout << " baseLab [-b macro] [-v macro] [-t nThreads] [-p emModel] [-r on|off]" << G4endl;
...
int main(int argc, char** argv)
{
  ...
  runManager->SetUserInitialization(new BaseLab::BaseLabActionInitialization(detector, emModel, enableRadioactiveDecay));
